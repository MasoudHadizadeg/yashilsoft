...
{
	public class CommonBaseDataRepository : GenericApplicationBasedRepository<CommonBaseData,int>, ICommonBaseDataRepository
    {
        private readonly YashilAppDbContext _context;
        private readonly IUserPrincipal _userPrincipal;
		public CommonBaseDataRepository (YashilAppDbContext context, IUserPrincipal userPrincipal) : base(context,userPrincipal)
            {
                _context = context;
