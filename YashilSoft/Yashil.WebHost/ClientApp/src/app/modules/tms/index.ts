...
import {RepresentationCourseCategoryListComponent} from './representation-course-category/representation-course-category-list.component';
...
import {PersonBankAccountListComponent} from './person-bank-account/person-bank-account-list.component';
...
export const COMPONENTS: Provider[] = [
    ...
    RepresentationTeacherListComponent,
    RepresentationTeacherDetailComponent,
    RepresentationCourseCategoryListComponent,
