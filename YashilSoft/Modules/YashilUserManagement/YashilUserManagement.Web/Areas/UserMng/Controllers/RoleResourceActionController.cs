...
{
	public class RoleResourceActionController : BaseController<RoleResourceAction ,int,RoleResourceActionListViewModel,  RoleResourceActionEditModel,RoleResourceActionSimpleViewModel>
    {
