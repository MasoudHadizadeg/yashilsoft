...
namespace Yashil.Core
{
    ...
    /// </summary>
    public class YashilCSharpEntityTypeGenerator : CSharpEntityTypeGenerator
    {
        ...
        public YashilCSharpEntityTypeGenerator(
        ...
        {
            YashilCheck.NotNull(entityType, nameof(entityType));
            YashilCheck.NotNull(@namespace, nameof(@namespace));
        ...
        protected override void GenerateClass(IEntityType entityType)
        {
            ...
            var prop = entityType.FindProperty("CreatorOrganizationId");
            //: 

            
            TemplateData.Add("base-class", prop == null ? "" : ",IApplicationBasedEntity");
        ...
        {
            YashilCheck.NotNull(property, nameof(property));
