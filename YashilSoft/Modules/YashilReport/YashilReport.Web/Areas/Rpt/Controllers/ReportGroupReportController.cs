...
{
	public class ReportGroupReportController : BaseController<ReportGroupReport ,int,ReportGroupReportListViewModel, ReportGroupReportViewModel, ReportGroupReportEditModel,ReportGroupReportSimpleViewModel>
    {
