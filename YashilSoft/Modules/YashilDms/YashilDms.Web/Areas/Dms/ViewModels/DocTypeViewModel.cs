...
namespace YashilDms.Web.Areas.Dms.ViewModels
{
    ...
    public class DocTypeEditModel : IBaseViewModel
    {
        ...
        [Range(0, int.MaxValue)] [Required] public int MaxSize { get; set; }

        [Range(0, int.MaxValue)] [Required] public int MaxCount { get; set; }

        [Range(0, int.MaxValue)] [Required] public int DocFormatId { get; set; }
        public string DocFormatTitle { get; set; }

        [Required] public bool IsImage { get; set; }

        [Required] public bool CropImage { get; set; }
